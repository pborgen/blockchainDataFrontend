...
export default function Sidebar({ open, setOpen, activeTab, setActiveTab, collapsed, setCollapsed }: SidebarProps) {
        ...
        <div className="relative mt-8 flex flex-1 flex-col gap-6 p-4">
          ...
          {!collapsed && (
            <div className="mt-auto rounded-lg border border-purple-500/20 bg-purple-900/10 p-4 shadow-[0_0_10px_rgba(128,0,255,0.1)]">
              <h3 className="text-sm font-medium text-purple-400">Network Status</h3>
              ...
              <div className="mt-2 flex items-center justify-between">
                ...
                <span className="text-xs font-medium text-green-400">12 Gwei</span>
              </div>
            </div>
          )}
